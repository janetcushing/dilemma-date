...
function GetLocation() {
    ...
    var address = document.getElementById("dnd-zipcode-input").value;
        ...
        if (status == google.maps.GeocoderStatus.OK) {
            ...
            $.get(
                ...
                function (data, status) {
                    ...
                    // take response data | slice off the first result | map over the result & create function to stick the restuarantdetails object you are building into restaurants variable
